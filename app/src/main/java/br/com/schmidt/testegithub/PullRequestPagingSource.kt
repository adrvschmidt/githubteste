...
class PullRequestPagingSource constructor(private val creator: String, private val repositoryName: String, application: Application): PagingSource<Int, ItemPullRequest>() {
    ...
    override suspend fun load(
        ...
        try {
            ...
            val response = backend.getAllPullRequestsFromRepository(creator, repositoryName, nextPageNumber)
            response?.let {
